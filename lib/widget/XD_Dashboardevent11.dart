...
class XD_Dashboardevent11 extends StatefulWidget {
  const XD_Dashboardevent11({
    Key? key, required String title }) : super(key: key);

  @override
  State<XD_Dashboardevent11> createState() => _XD_Dashboardevent11State();
}

class _XD_Dashboardevent11State extends  State<XD_Dashboardevent11> {
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: BackdropFilter(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(20.0), //พื้นหลัง
                ),
              ),
            ),
          ),
          ...
          Pinned.fromPins(
            ...
            Pin(size: 18.0, start: 64.5), //ตำแหน่งlevel
            child: Stack(
              children: <Widget>[
                Align(
          ...
          Pinned.fromPins(//หัวข้อล่างlevel
            Pin(start: 33.2, endFraction: 0.0415),
            Pin(size: 21.4, start: 104.7), //หัวข้อล่างlevel
            child: Stack(
              children: <Widget>[
                Align(
                  alignment: Alignment.topLeft,
          ...
          Pinned.fromPins(
            Pin(start: 23.0, endFraction: 0.0304), //ขนาดสีซ้ายขวา
            Pin(size: 38.0, start: 136.0), //ขนาดสีบนล่าง
          ...
          Pinned.fromPins(
            Pin(start: 33.2, endFraction: 0.0378), //ตำแหน่ง
              ...
              children: <Widget>[
                ...
                Align(
                  ...
                  GestureDetector(
                    ...
                    child: SvgPicture.asset(
                      'assets/image/important_fill_icon.svg',
                      height: 28.0,
                      width: 60.0,
                    ),
                  ),
                ...
                Align(
                  ...
                  child: Stack(
                    ...
                    onTap: () => {},
                    child: SvgPicture.asset(
                      'assets/image/memo_fill_icon.svg',
                      width: 66.0,
                      height: 28.0,
                    ),
                      ),
          ...
          Pinned.fromPins(
              ...
              children: <Widget>[
                ...
                Align(
                  ...
                  GestureDetector(
                    onTap: () => {},
                    child: SvgPicture.asset(
                      'assets/image/important_outline_icon.svg',
                      width: 60.0,
                      height: 28.0,
                ...
                Align(
                  ...
                  child: Stack(
                    ...
                    onTap: () => {},
                    child: SvgPicture.asset(
                      'assets/image/memo_outline_icon.svg',
                      width: 66.0,
                      height: 28.0,   
                    ),
                      ),
            ...
            Pinned.fromPins(//หัวข้อใหญ่
            Pin(size: 222.0, start: 32.5),
            Pin(size: 26.0, start: 22.7), //หัวข้อใหญ่
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
